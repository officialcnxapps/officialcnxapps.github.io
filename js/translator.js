jQuery(document).ready(function ($) {
	...
	const dicionario = {
		"pt-br": {
			...
			Descricao_Endless_Arena: "Enfrente inimigos em arenas épicas para ser o campeão!",
			...
			Sobre_Endless_Arena: "Endless Arena é um jogo de ação e estratégia onde você pode evoluir seu personagem enfrentando os mais diversos inimigos em batalhas de arena. Ganhe ouro e experiência para melhorar suas habilidades e equipamentos e se tornar o campeão da arena!",
		...
		"en-us": {
			...
			Descricao_Endless_Arena: "Face enemies in epic arenas to be the champion!",
			...
			Sobre_Endless_Arena: "Endless Arena is an action-strategy game where you can evolve your character by facing the most diverse enemies in arena battles. Earn gold and experience to improve your skills and equipment and become the arena champion!",
