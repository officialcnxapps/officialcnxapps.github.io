...
public class Valanya extends DataHelper {
    ...
    Npc npc() {
        ...
        cv1.addOptionText(ENGLISH, "What brings you to Esperand?", "I'm studying the jewelry trade here. The craftsmen in this region are renowned for their skill with precious stones. It's fascinating work!");
        cv1.addOptionText(PORTUGUESE, "O que te traz a Esperand?", "Estou estudando o comércio de joias aqui. Os artesãos desta região são renomados por sua habilidade com pedras preciosas. É um trabalho fascinante!");
        cv1.addOptionText(SPANISH, "¿Qué te trae a Esperand?", "Estoy estudiando el comercio de joyas aquí. Los artesanos de esta región son reconocidos por su habilidad con piedras preciosas. ¡Es un trabajo fascinante!");
        ...
        npc.requirementValidations = (chara, ctx) -> {
            if (isInsideAvailableHours(9, 15)) {
