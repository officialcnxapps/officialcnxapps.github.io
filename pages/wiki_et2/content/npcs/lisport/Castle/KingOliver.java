...
public class KingOliver extends DataHelper {
    ...
    Npc kingOliver() {
        ...
        npc.addDescriptionTranslation(SPANISH, "Astuto, imponente y serio. Lucha por los ideales de Lisport pero aún necesita más tiempo para convertirse en un gran rey.\nAlgunos de sus métodos pueden ser más rústicos, necesita aceptar mejor los cambios de las eras.\n\nTrasos físicos: Ojos azules marcantes. Cabello y barba grisáceos. Físico esbelto con arrugas leves por la edad.");
        ...
        ConversationOption cvKingdomsCup1 = new ConversationOption(0, 20);
        ...
        ConversationOption cvKingdomsCup2 = new ConversationOption(20, 21);
        ...
        ConversationOption cvKingdomsCupPersuade = new ConversationOption(21, 0);
        ...
        ConversationOption cvKingdomsCupPay = new ConversationOption(21, 0);
        ...
        ConversationOption cvKingdomsCupDecline = new ConversationOption(21, 0);
