package com.cnx.endlesstalestwo.data.npcs.havarusSouth.helera.tavern;
...
public class Felicia extends DataHelper {
    @Override
    ...
    Npc npc() {
        ...
        cv1.addOptionText(ENGLISH, "Can I get a drink?", "Coming right up! We've got the best ale this side of the kingdom. Don't let the occasional brawl fool you, my friend. This is a fine establishment, full of life and stories.");
        cv1.addOptionText(PORTUGUESE, "Pode me servir uma bebida?", "Já vai sair! Temos a melhor cerveja deste lado do reino. Não se deixe enganar pela briga ocasional, meu amigo. Este é um estabelecimento de primeira, cheio de vida e histórias.");
        cv1.addOptionText(SPANISH, "¿Me pones una copa?", "¡Marchando! Tenemos la mejor cerveza de este lado del reino. No dejes que una pelea ocasional te engañe, amigo mío. Este es un establecimiento de primera, lleno de vida e historias.");
        npc.conversationOptions.add(cv1);

        ConversationOption newCv = new ConversationOption(0, 0);
        newCv.addOptionText(ENGLISH, "Any interesting rumors?", "Hah! In a place like this? Rumors are more common than spilled beer! Stick around, keep your ears open, and your mug full. You're bound to hear something juicy. Or... you could just ask me nicely. I see and hear everything in this tavern.");
        newCv.addOptionText(PORTUGUESE, "Algum boato interessante?", "Hah! Num lugar como este? Boatos são mais comuns que cerveja derramada! Fique por aqui, mantenha os ouvidos abertos e a caneca cheia. Com certeza vai ouvir algo suculento. Ou... você poderia simplesmente me perguntar com jeitinho. Eu vejo e ouço tudo nesta taverna.");
        newCv.addOptionText(SPANISH, "¿Algún rumor interesante?", "¡Ja! ¿En un lugar como este? ¡Los rumores son más comunes que la cerveza derramada! Quédate por aquí, mantén los oídos abiertos y la jarra llena. Seguro que oirás algo jugoso. O... podrías preguntarme amablemente. Lo veo y oigo todo en esta taberna.");
        npc.conversationOptions.add(newCv);
        ...
        cv2.addOptionText(SPANISH, "¿Qué ha pasado aquí? Esa pelea de bar...", "Bueno, Brants y Falkers, ya sabes... esas dos familias tienen problemas desde hace años.");
        ...
        cv4.addOptionText(ENGLISH, "Brants and Falkers? Tell me more.", "So, you are not from here, right? Because everybody knows them.\nTwo powerful families, the Brants and the Falkers, have long been at odds. It all began when Sir Martyn Brant, advisor to King Oriun, ordered the construction of a prison on lands that belonged to Lord Den Falker. An affront, don't you think? But in return, Lord Den was given lands in the north, where he founded a village. Many say it was a fair deal, despite those lands being terrible for planting. But... some say it was revenge for something much more personal.\n<He leans closer and lowers his voice>\nThey say that Lord Den had promised his daughter, Lady Lara, to Sir Martyn's son, Sir Jard Brant. But the girl didn't want to marry. She didn't like Jard, she thought he was arrogant, a womanizer... and she asked her father to cancel the marriage. And what happened next? Ah... Well, it depends on what you want to know first.");
        cv4.addOptionText(PORTUGUESE, "Brants e Falkers? Conte-me mais.", "Então, você não é daqui, certo? Porque todo mundo os conhece.\nDuas famílias poderosas, os Brant e os Falker, há muito tempo vivem em desavença. Tudo começou quando Sir Martyn Brant, conselheiro do rei Oriun, ordenou a construção de uma prisão em terras que pertenciam a Lorde Den Falker. Uma afronta, não acha? Mas, como compensação, Lorde Den recebeu terras no norte, onde fundou um vilarejo. Muitos dizem que foi um acordo justo, apesar daquelas terras serem péssimas para plantio. Mas... há quem diga que foi vingança por algo bem mais pessoal.\n<Ele se inclina para mais perto e baixa a voz>\nDizem que Lorde Den havia prometido sua filha, Lady Lara, ao filho de Sir Martyn, Sir Jard Brant. Mas a moça não queria se casar. Não gostava de Jard, o achava arrogante, um mulherengo... e pediu ao pai que cancelasse o casamento. E o que aconteceu depois? Ah... Bem, depende do que deseja saber primeiro.");
        cv4.addOptionText(SPANISH, "¿Brants y Falkers? Cuéntame más.", "Entonces, no eres de aquí, ¿verdad? Porque todo el mundo los conoce.\nDos familias poderosas, los Brant y los Falker, han estado en desacuerdo durante mucho tiempo. Todo comenzó cuando Sir Martyn Brant, asesor del rey Oriun, ordenó la construcción de una prisión en tierras que pertenecían a Lord Den Falker. Una afrenta, ¿no crees? Pero, a cambio, Lord Den recibió tierras en el norte, donde fundó un pueblo. Muchos dicen que fue un trato justo, a pesar de que esas tierras eran terribles para la siembra. Pero... algunos dicen que fue una venganza por algo mucho más personal.\n<Se inclina más cerca y baja la voz>\nDicen que Lord Den había prometido a su hija, Lady Lara, al hijo de Sir Martyn, Sir Jard Brant. Pero la chica no quería casarse. No le gustaba Jard, lo consideraba arrogante, un mujeriego... y le pidió a su padre que cancelara el matrimonio. ¿Y qué pasó después? Ah... Bueno, depende de lo que quieras saber primero.");
        ...
        ConversationOption cv7 = new ConversationOption(2, 4);
