...
public class ProtectionShop {
    public Shop create() {
        Shop shop = new Shop("Protection Shop", 7, 19);
        shop.addNameTranslation(CoreEnums.AvailableLanguages.PORTUGUESE, "Loja da Proteção");
        shop.addNameTranslation(CoreEnums.AvailableLanguages.SPANISH, "Tienda de la Proteción");
        ...
        shop.addStockItem(ItemsIds.MAGICAL_LIGHT_PLATE);
